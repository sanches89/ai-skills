...
- `description`, required: 1 to 1024 characters; what the skill does and when to
...
- `metadata`, optional: string-to-string map for client-specific data; use
  distinctive key names.
...
`scripts/extract.py`. Keep references one level deep from `SKILL.md`.
