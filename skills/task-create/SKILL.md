...
**2a. Codebase.** Locate the areas the idea touches and read the actual code, not only file names. Record, with paths and line numbers:
...
- If the answer or a user remark introduces an adjacent topic, ask one question: include it in scope, or list it under *Out of scope*. Never silently expand or drop it.
