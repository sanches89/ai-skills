...
Fill every section. Replace every `<placeholder>`. Keep the headings exactly as written: the task becomes the body of one item or one `task.md` file, and the `task-breakdown` skill reads this same format later to fill the Subtasks section.
